...
- **محرر كود تفاعلي بواجهات البجروت**: المكدس — `push`, `pop`, `top`, `isEmpty`؛ الطابور — `insert`, `remove`, `head`, `isEmpty` (مع قبول `enqueue`/`dequeue` كأسماء بديلة). الكود يتحول إلى حركة سطرًا بسطر مع تمييز السطر النشط ورسائل خطأ بالعربية (هيكلا الفرز والقائمة يُحرَّكان من أزرار العمليات)
- **عام النوع مثل القالب T**: القيم أعداد أو نصوص (`push("أحمد")‎`)، وكل هيكل يحمل نوعًا واحدًا — خلط نص مع أعداد يُرفض برسالة عربية، والتصريح `new Stack<string>()‎` ينشئ هيكلًا جديدًا فارغًا ويُلزم نوعه المعلن
